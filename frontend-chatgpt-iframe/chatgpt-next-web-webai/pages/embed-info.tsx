/**
 * Embed Info page - provides instructions for iframe usage
 * (Previously the root index page)
 */
...
export default function EmbedInfoPage() {
  ...
  return (
    <div className="home-page">
      <Head>
        <title>WebAI Chat - Embed Instructions</title>
        <meta name="description" content="AI Chat Assistant powered by WebAI - Embedding Instructions" />
