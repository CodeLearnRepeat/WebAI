(function () {
    ...
    const styles = `
      ...
      @media (min-width: 1024px) {
        ...
        #webai-chat-widget {
          ...
          width: 420px; max-height: calc(100vh - 40px);
      ...
      @media (max-width: 1023px) {
        ...
        #webai-chat-widget {
          ...
          height: 75vh; max-height: 640px; transform: translateY(110%);
        }
      ...
      #webai-chat-widget {
        ...
        border-radius: 14px; box-shadow: var(--webai-shadow);
        display: flex; flex-direction: column; overflow: hidden;
        transition: transform .3s ease, opacity .3s ease; opacity: 1;
      }
      #webai-chat-header {
        background: linear-gradient(135deg, var(--webai-primary) 0%, var(--webai-primary-2) 100%);
        color: var(--webai-primary-contrast); padding: 14px 12px;
      ...
      .webai-message {
        ...
        animation: webai-fadeIn .25s ease;
      }
      ...
      .webai-message-user .webai-message-avatar { background: var(--webai-primary); color: var(--webai-primary-contrast); }
      .webai-message-content {
        max-width: 80%; background: var(--webai-card); color: var(--webai-text);
        padding: 10px 12px; border-radius: 12px; border: 1px solid var(--webai-border);
      ...
      #webai-chat-input-container {
        background: var(--webai-card); border-top: 1px solid var(--webai-border);
        padding: 10px; display: flex; gap: 8px; align-items: flex-end;
      }
      #webai-chat-input {
        flex: 1; min-height: 44px; max-height: 160px;
        padding: 10px 12px; border-radius: 10px; border: 1px solid var(--webai-border);
      ...
      #webai-chat-toggle {
        ...
        background: linear-gradient(135deg, var(--webai-primary) 0%, var(--webai-primary-2) 100%);
        color: var(--webai-primary-contrast); border: none; cursor: pointer; z-index: 999998;
        box-shadow: var(--webai-shadow); display: inline-flex; align-items: center; justify-content: center;
      ...
      <div id="webai-chat-widget" aria-hidden="true" aria-label="WebAI Chat">
        <div id="webai-chat-header">
          ...
          <div class="webai-header-actions">
            <button id="webai-theme-toggle" class="webai-icon-btn" title="Toggle theme" aria-label="Toggle theme">🌓</button>
            <button id="webai-chat-close" class="webai-icon-btn" title="Close" aria-label="Close">✕</button>
          </div>
        </div>
        <div id="webai-chat-messages" role="log" aria-live="polite"></div>
    ...
    // Display-only messages for this session (no persistence)
